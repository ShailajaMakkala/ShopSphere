            ...
            <div className="max-w-4xl w-full">
                ...
                <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm mb-10 overflow-hidden">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-sm font-bold text-violet-600 font-mono tracking-tighter">#{order.transaction_id || order.id}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative mt-20 mb-32 px-4">
                    ...
                    <motion.div
                        ...
                        className="absolute top-1/2 left-0 h-1 bg-gradient-to-r from-orange-500 to-purple-600 -translate-y-1/2 z-10"
                    ></motion.div>
                                ...
                                <div key={step.id} className="flex flex-col items-center group">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-500 ${isCompleted
                                                ...
                                                : isCurrent
                                                    ? "bg-white border-violet-600 text-violet-600 shadow-xl shadow-gray-200 scale-125 z-30"
                                    ...
                                    <div className="absolute -bottom-16 w-32 text-center pointer-events-none">
                                        ...
                                        {isCurrent && (
                                            <span className="text-[8px] font-black text-violet-500 bg-violet-50 px-2 py-0.5 rounded-full uppercase tracking-tighter mt-1 inline-block">
                                                Active Step
                                            </span>
                                        )}
                                    </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <span className="text-[10px] font-black text-orange-600 uppercase tracking-widest">2 hours ago</span>
                                </div>
                            </div>
                        </div>
                    </div>
