    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fff5f5] via-[#fef3f2] to-[#f3e8ff] p-4 lg:p-6 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-6xl flex flex-row-reverse bg-white/40 backdrop-blur-3xl rounded-[40px] shadow-2xl overflow-hidden border border-white/50">
                ...
                {/* Right Side: Image / Hero (Flipped for variety) */}
                        ...
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl">
                            ...
                            <div className="grid grid-cols-2 gap-6 mt-8">
                                <div className="space-y-1">
                                    <p className="text-2xl font-black">20k+</p>
                                    <p className="text-white/60 text-xs font-bold uppercase tracking-widest">Premium Brands</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-2xl font-black">24/7</p>
                                    <p className="text-white/60 text-xs font-bold uppercase tracking-widest">Customer Support</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-md mx-auto w-full">
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-white border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 transition-all duration-300 hover:border-orange-300 focus:outline-none focus:ring-4 focus:ring-orange-400/5 focus:border-orange-400"
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-gray-500 font-medium">
                                ...
                                <Link to="/login" className="font-black text-orange-400 hover:text-orange-500 transition-colors underline decoration-orange-400/30 underline-offset-4 decoration-2">
                                    Sign in here
                                </Link>
                            </p>
                        </div>
