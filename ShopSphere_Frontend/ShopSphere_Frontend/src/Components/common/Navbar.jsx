                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="hidden md:flex items-center flex-grow justify-end ml-8 gap-4">
                        <div className="flex items-center gap-4 w-full max-w-4xl">
                            ...
                            >
                                <FaHome
                                    size={20}
                                    className={`transition-transform duration-300 group-hover:scale-110 drop-shadow-lg ${isActive("/home") ? "drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]" : ""}`}
                                />
                            </Link>
                            ...
                            >
                                <div className="relative w-full group">
                                    ...
                                    />
                                    <FaSearch
                                        className={`absolute left-4 top-1/2 -translate-y-1/2 transition-all duration-300 ${searchFocused ? "text-orange-500" : "text-white"
                                            } z-10`}
                                        size={16}
                                    />
                                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 z-10">
                                        {searchQuery && (
                                            <button
                                                ...
                                                className="p-1.5 text-orange-300 hover:text-white transition-colors duration-200"
                                        ...
                                        <button
                                            ...
                                            title="Voice Search"
                                        >
                                            <FaMicrophone size={15} className={isListening ? "animate-pulse" : ""} />
                                        </button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        >
                            ...
                            />
                            {wishlistCount > 0 && (
                                <span className="absolute -top-1 -right-1 min-w-[20px] h-[20px] px-1 bg-gradient-to-r from-rose-500 to-pink-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow-lg shadow-rose-500/30 animate-in zoom-in duration-200 ring-2 ring-[#a78bfa]">
                        ...
                        >
                            <FaShoppingCart
                                size={18}
                                className={`transition-transform duration-300 group-hover:scale-110 drop-shadow-lg ${isActive("/cart") ? "drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]" : ""}`}
                            />
                            {cartCount > 0 && (
                                <span className="absolute -top-1 -right-1 min-w-[20px] h-[20px] px-1 bg-gradient-to-r from-orange-400 to-orange-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow-lg shadow-orange-400/30 animate-in zoom-in duration-200 ring-2 ring-[#c084fc]">
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                >
                                    ...
                                    <div className="hidden sm:flex flex-col items-start leading-tight">
                                        <span className="text-[10px] text-orange-200 font-medium uppercase tracking-wider">Hello</span>
                                    ...
                                    <FaChevronDown
                                        size={10}
                                        className={`ml-1 transition-transform duration-300 text-orange-200 ${profileDropdownOpen ? "rotate-180" : ""}`}
                                    />
                                </button>
                                ...
                                {profileDropdownOpen && (
                                    <div className="absolute right-0 mt-3 w-60 bg-[#581c87]/95 backdrop-blur-xl rounded-2xl shadow-xl shadow-black/50 border border-white/10 py-2 animate-in slide-in-from-top-2 duration-200 overflow-hidden transform origin-top-right ring-1 ring-white/5">
                                        ...
                                        <div className="px-2 py-2">
                                            ...
                                            >
                                                <FaUser size={14} className="text-orange-300" />
                                                My Profile
                                            </Link>
                                            <Link
                                                to="/orders"
                                                ...
                                                onClick={() => setProfileDropdownOpen(false)}
                                            >
                                                <FaBox size={14} className="text-orange-300" />
                                                My Orders
                                            </Link>
                                        </div>
