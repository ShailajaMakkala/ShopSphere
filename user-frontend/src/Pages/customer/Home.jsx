...
const Home = () => {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            ...
            if (searchQuery.trim() !== currentUrlSearch) {
                if (searchQuery.trim()) {
                    navigate(`/home?search=${encodeURIComponent(searchQuery.trim())}`, { replace: true });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#fff5f5] via-[#fef3f2] to-[#f3e8ff] dark:from-[#0f172a] dark:via-[#1e1b4b] dark:to-[#020617] transition-colors duration-500">
            ...
            <section id="products-section" className="max-w-[1600px] mx-auto px-3 sm:px-6 md:px-12 py-8 sm:py-12 md:py-16">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4 mb-6 sm:mb-10">
                    <div className="space-y-1">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white tracking-tight">FEATURED PRODUCTS</h2>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap w-full md:w-auto">
                        ...
                        <div className="relative group flex-1 md:flex-none">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-800 dark:text-white border border-gray-200 dark:border-slate-700 rounded-2xl text-sm font-medium outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-400/5 transition-all md:w-64"
                            />
                        </div>
