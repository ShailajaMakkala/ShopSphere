...
const SidebarContent = memo(({ collapsed, isDarkMode, menu, location, onLogout }) => (
    <div className="relative h-full flex flex-col p-4 z-10">
        ...
        <div className="flex justify-between items-center mb-10 px-2 h-16">
            <Link to="/delivery/dashboard" className="flex items-center gap-0 group">
                <img src="/s_logo.png" alt="ShopSphere" className="w-16 h-16 object-contain transition-transform duration-300 group-hover:scale-110 mb-3 mr-0.5" loading="lazy" />
                {!collapsed && (
    ...
    return (
        <>
            ...
            >
                ...
                <SidebarContent collapsed={false} isDarkMode={isDarkMode} menu={menu} location={location} onLogout={onLogout} />
            </aside>
            ...
            >
                {isDarkMode && <div className="absolute inset-0 bg-gradient-to-b from-indigo-500/5 via-transparent to-purple-500/5 pointer-events-none" />}
                <SidebarContent collapsed={desktopCollapsed} isDarkMode={isDarkMode} menu={menu} location={location} onLogout={onLogout} />
            </aside>
